...
public class DatabaseConnection {
    // Database details
    private static final String URL = "jdbc:postgresql://localhost:5432/Billing_management_database"; // Database URL
    private static final String USER = "root"; // PostgreSQL username
